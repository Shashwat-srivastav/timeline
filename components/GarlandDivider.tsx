  ...
  return (
    <div className={`w-full flex justify-center items-center py-8 select-none pointer-events-none opacity-60 ${className}`}>
        <div className="flex items-center text-sw-lavender/50">
            {/* Left tapered line */}
            <div className="w-12 md:w-24 h-[1px] bg-gradient-to-r from-transparent to-current"></div>
            ...
            {/* Right tapered line */}
            <div className="w-12 md:w-24 h-[1px] bg-gradient-to-l from-transparent to-current"></div>
        </div>
    </div>
  );
};