    ...
    <div className="w-full py-16 animate-slide-up" style={{ animationDelay: '400ms' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-center overflow-x-auto pb-8 pt-4">
            <div 
                ref={scrapbookRef}
                className="relative flex flex-col md:flex-row w-[900px] h-[650px] bg-white shadow-2xl rounded-sm overflow-hidden shrink-0"
                style={{
            ...
            >
                ...
                {/* --- SPINE --- */}
                <div className="absolute left-1/2 top-0 bottom-0 w-8 -ml-4 z-30 pointer-events-none">
