        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/50 shadow-soft rounded-3xl p-6 relative overflow-hidden transition-all duration-500 hover:shadow-glow hover:-translate-y-1">
            ...
            <div className="grid grid-cols-2 gap-4">
                <button
                    ...
                    className={`col-span-1 py-4 font-body font-bold text-xs uppercase tracking-widest rounded-xl transition-all duration-300 flex items-center justify-center gap-2 border border-transparent ${
                        moments.length === 0 
                ...
                >
                 ...
                 <button
                    ...
                    className={`col-span-1 py-4 font-body font-bold text-xs uppercase tracking-widest rounded-xl transition-all duration-300 flex items-center justify-center gap-2 border border-gray-200 ${
                        moments.length === 0 
