...
export const MomentForm: React.FC<MomentFormProps> = ({ onAddMoment }) => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-soft p-10 relative animate-slide-up transition-all duration-500 hover:shadow-glow hover:-translate-y-1 border border-white/50" style={{ animationDelay: '100ms' }}>
      ...
      <div className="flex justify-between items-end mb-8 border-b border-gray-100/50 pb-4">
        ...
        <div className="text-sw-sub font-accent italic text-lg">Curate your story</div>
      </div>
